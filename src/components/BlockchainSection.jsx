          ...
          <div className="bg-red-50 dark:bg-red-900/30 rounded-xl p-8 border-2 border-red-200 dark:border-red-700">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-navy">Vous initiez le transfert</p>
                  <p className="text-sm text-gray-600">Frais de démarrage</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-red-300 flex items-center justify-center text-white font-bold">2</div>
                <div>
                  <p className="font-semibold text-navy">Passage par des intermédiaires</p>
                  <p className="text-sm text-gray-600">Chaque intermédiaire prend sa part</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-red-300 flex items-center justify-center text-white font-bold">3</div>
                <div>
                  <p className="font-semibold text-navy">Conversion de devises</p>
                  <p className="text-sm text-gray-600">Mauvais taux de change</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-red-300 flex items-center justify-center text-white font-bold">4</div>
                <div>
                  <p className="font-semibold text-navy">Délai d'attente</p>
                  <p className="text-sm text-gray-600">Plusieurs jours</p>
                </div>
              </div>
          ...
          <div className="bg-emerald-50 dark:bg-emerald-900/30 rounded-xl p-8 border-2 border-emerald dark:border-emerald/70">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-navy">La blockchain traite</p>
                  <p className="text-sm text-gray-600">Aucun intermédiaire</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-emerald flex items-center justify-center text-white font-bold">3</div>
                <div>
                  <p className="font-semibold text-navy">Conversion optimale</p>
                  <p className="text-sm text-gray-600">Meilleur taux du marché</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-emerald flex items-center justify-center text-white font-bold">4</div>
                <div>
                  <p className="font-semibold text-navy">Arrivée instantanée</p>
                  <p className="text-sm text-gray-600">Quelques secondes</p>
                </div>
              </div>
